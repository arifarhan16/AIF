...
def baliho():
	try:
		...
		print ' ' + W
		print ('FB MU >> ['+ name + '] << ('+ G +'Secure Mode'+ W +')').center(44)
		print ' '
		...
		print ' ' + W
		print ('AIF').center(44)
		print (W + '     [' + G +'Account Information Facebook'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Cy#b3r00q 'Arikun' Ft Mr.K4hh
    Name       AIF 'Account Information Facebook'
...
def info_ga():
	...
	print '''
     %sPerintah                      Penjelas%s
  [+]=========[+] [+]==========================================[+]
  [+]
  [+] get_data           Mengambil Semua Data Teman
  [+] get_info           Perlihatkan Informasi Tentang Teman
  [+] dump_id            Mengambil Semua ID Dari Daftar Teman
  [+] dump_phone         Memngambil Semua Nomer Telpon Dari Daftar Teman
  [+] dump_mail          Mengambil Semua EMAIL Dari Daftar Teman
  [+] token              Buat Akses Loginmu !
  [+] cat_token          Tampilkan Akses Token !
  [+] rm_token           Buang Akses Tokenmu 
  [+] bot                Tipe Bot Facebook
  [+] clear              Bersihkan Terminal
  [+] help               Bantuan !
  [+] about              Tampilkan Informasi Program Ini
  [+] exit               Keluar
  [+]
  [+]=========[+] [+]==========================================[+]
'''%(G,W)
def menu_bot():
 ...
 [+]========[+] [+]============================[+]
   ...
   [ 01 ]      		auto tanggapi emoji
   [ 02 ]      		auto komen
   [ 03 ]      		auto poke
   [ 04 ]      		Terima Semua Permintaan Pertemanan 
   [ 05 ]      		Hapus Semua Kiriman
   [ 06 ]      		Hapus Semua Teman
   [ 07 ]      		Hapus Mengikuti Teman
   [ 08 ]      		Hapus Semua Foto
...
def get(data):
	...
	try:
		...
		print '[*] Akses Token Ada Di cookie/token.log'
		exit()
	except KeyError:
		print '[!] Gagal Membuat Akses Token'
		print '[!] Cek Internetmu, Email atau Password Facebook !'
		os.remove('cookie/token.log')
		main()
	except requests.exceptions.ConnectionError:
		print '[!] Gagal Membuat Akses Token !'
		print '[!] Tidak Ada Sambungan Internet'
		os.remove('cookie/token.log')
		main()
def id():
	print '[*] Masuk Akun Facebook        ';id = raw_input('[?] Username : ');pwd = getpass.getpass('[?] Password : ');API_SECRET = '62f8ce9f74b12f84c123cc23437a4a32';data = {"api_key":"882a8490361da98702bf97a021ddc14d","credentials_type":"password","email":id,"format":"JSON", "generate_machine_id":"1","generate_session_cookies":"1","locale":"en_US","method":"auth.login","password":pwd,"return_ssl_resources":"0","v":"1.0"};sig = 'api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail='+id+'format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en_USmethod=auth.loginpassword='+pwd+'return_ssl_resources=0v=1.0'+API_SECRET
	x = hashlib.new('md5')
        x.update(sig)
...
def post():
	...
	try:
	  if WT == 'wallpost':
		...
		print '[*] Mendapatkan Semua ID Postingan'
		...
		print '[*] Mendapatkan Semua Permintaan Teman...'
		...
		print '[*] Mendapatkan Semua ID Teman....'
		...
		print '[*] Mendapatkan Semua ID album ...'
		...
		print '[*] Mendapatkan Semua ID Post....'
		...
		print '[!] Gagal Mengambil Semua ID Postingan'
		print '[!] BERHENTI !'
		bot()
	except requests.exceptions.ConnectionError:
		print '[!] Jaringan Galat'
		print '[!] BERHENTI'
		bot()
	except KeyboardInterrupt:
		print '\r[!] DIBERHENTIKAN                                      '
		bot()
def like(posts , amount):
	global type , token , WT

	print '\r[*] Semua ID Postingan Sukses Diambil            '
	print '[*] Mulai'
		...
		for post in posts:
			...
			try:
				...
				try:
					...
					print '\r' + W + '[' + G + id + W + '] Sukses Like Semua Status'
		...
		for post in posts:
			...
			try:
				...
				try:
					...
					print W + '[' + G + id + W + '] Sukses Komentar'
		print '[*] OK'
		bot()
	except KeyboardInterrupt:
                print '\r[!] DIBERHENTIKAN'
...
def confirm(posts):
	...
	print '\r[*] Semua Permintaan Pertemanan Telah Sukses      '
	print '[*] Mulai'
	...
	try:
		...
		for post in posts:
			...
			try:
				...
				print W + '[' + G + post['from']['name'] + W + '] Diterima!'
		print '[*] OK'
		bot()
	except KeyboardInterrupt:
		print '\r[!] DIBERHENTIKAN'
...
def unfollow(posts):
	...
	print '\r[*] Semua ID Sukses Diterima    '
	print '[*] Mulai'
	...
	try:
		...
		for post in posts['data']:
			...
			try:
				...
				print W + '[' + G + post['name'] + W + '] Berhenti Mengikuti '
		print '[*] OK'
		bot()
	except KeyboardInterrupt:
		print '\r[!] DIBERHENTIKAN'
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'Cy#b3r00q' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
	...
	if cek in ['1','01']:
		...
		try:
			...
			print '[!] token akses sudah ada'
			cek = raw_input('[?] Ingin Melanjutkan [Y/N] ')
			if cek.lower() != 'y':
				print '[*] Dibatalkan '
				bot()
		except IOError:
		...
		print '\n' + '[*] Membuat Akses Token Facebook [*]'.center(44) + '\n'
		print '[Warn] Matikan VPN Untuk Menggunakan Fitur Ini  !!!'
		id()
	elif cek in ['0','00']:
		...
		if cek == '':
			...
			print "[!] Ketik 'menu' Untuk Melihat Menu Bot"
			menu_reaction_ask()
  except KeyboardInterrupt:
	menu_reaction_ask()
...
def bot_ask():
	...
	print '[*] Mengecek Akses Token '
	try:
		token = open('cookie/token.log','r').read()
		print '[*] Sukses Mengecek Akses Token'
	except IOError:
		print '[!] Gagal Mengecek Akses Token'
		print "[!] Ketik 'token' Untuk Membuat Akses"
		menu_reaction_ask()
...
def bot():
  try:
	...
	cek = raw_input(R + 'Cy#b3r00q' + W +'/' + R +'Bot ' + W + '>> ')
	...
	if cek in ['1','01']:
		...
		try:
			token = open('cookie/token.log','r').read()
		        print '[*] Success Mengecek Akses Token'
		except IOError:
	                print '[!] Gagal Mengecek Akses Token'
			print "[!] Ketik 'token' Untuk Membuat Akses"
	                bot()
		...
		if cek == '':
			...
			print "[!] command '"+cek+"' not found"
			print '[!] etik "menu" untuk melihat menu bot'
			bot()
  except KeyboardInterrupt:
	bot()
#
...
def dump_id():
	...
	try:
		...
		out.close()
		print '\r[*] Semua ID Teman Telah Berhasil Diterima'
		...
		print '[!] Gagal Mendapatkan ID Teman'
		main()
...
def dump_phone():
	...
	print "[*] Mengambil Semua Nomor Telpon"
	print '[*] Mulai'
	...
	try:
		...
		out.close()
		print '[*] OK'
		print "[*] Semua Nomor Telah Sukses Diterima"
		...
		print "[!] Semua Nomor Gagal Diterima"
		main()
	except (requests.exceptions.ConnectionError , requests.exceptions.ChunkedEncodingError):
		print '[!] Jaringan Galat'
		print '[!] DIBERHENTIKAN'
...
def dump_mail():
	...
	try:
		...
		out.close()
                ...
                print '[*] OK'
                print "[*] Semua Email Telah Sukses Diterima"
		...
		print "[!] Semua Email Gagal Diterima"
		main()
	except (requests.exceptions.ConnectionError , requests.exceptions.ChunkedEncodingError):
		print '[!] Jaringan Galat'
		print '[!] DIBERHENTIKAN'
...
def main():
  ...
  try:
	cek = raw_input(R + 'Cy#b3r00q' + W +' >> ')

	if cek.lower() == 'get_data':
		if len(jml) == 0:
			getdata()
		else:
			print '[*] Kamu Menerima %s Data Teman'%(len(jml))
			main()
		...
		try:
			...
			print '[!] Gagal Membuka cookie/token.log'
			print "[!] Ketik 'token' Untuk Membuat Akses"
			main()
		...
		print '''
[Warn] Kamu Harus Membuat Akses Token Lagi 
       Jika Akses Tokenmu Dihapus ! 
'''
		a = raw_input("[!] ketik 'delete' Untuk Melanjutkan : ")
		if a.lower() == 'delete':
			try:
				os.system('rm -rf cookie/token.log')
				print '[*] Sukses Menghapus cookie/token.log'
				main()
			except OSError:
				print '[*] Gagal Menghapus cookie/token.log'
				main()
		else:
			print '[*] Gagal Menghapus cookie/token.log'
			main()
	...
	if 'dump_' in cek.lower() and cek.lower().split('_')[2] == 'id':
		...
		if cek == '':
			...
			print "[!] command '"+cek+"' not found"
			print '[!] ketik "help" untuk tampilkan menu program '
			main()
  except KeyboardInterrupt:
	main()
  except IndexError:
	print '[!] GAK ADA KOK MAKSAIN >.<  : ' + cek
	main()
#
######################################################################################################################
...
def getdata():
	...
	print '[*] Mengambil Semua Data Teman'
	...
	try:
		...
		print '[!] Akses Tokenmu KADALUARSA Silahkan Buat Kembali'
		print "[!] Ketik 'token' Untuk Membuat Akses"
		main()
	...
	for i in a['data']:
		jml.append(i['id'])
		print '\r[*] Mengambil %s Data Dari Teman '%(len(jml)),;sys.stdout.flush();time.sleep(0.0001)

	print '\r[*] '+str(len(jml))+' Data Temanmu Sukses Diterima'
	main()

def search():

	if len(jml) == 0:
                print "[!] Tak Ada Teman Di Database"
                print '[!] ketik "get_data" Untuk Mendapatkan Data Teman'
                main()
        else:
                pass

	target = raw_input("[!] Cari Menggunakan Nama Atau ID: ")
	...
	for i in a['data']:
	  ...
	  if target in  i['name'] or target in i['id']:
		...
		try:
			...
			pass
		try:
			print '[*] Nomor Handphone : '+y['mobile_phone']
		except KeyError:
			pass
		try:
			print '[*] Nama : '+y['name']
			...
			pass
		try:
			print '[*] Name Awal : '+y['first_name']
		except KeyError:
			pass
		try:
			print '[*] Name Tengah : '+y['middle_name']
		except KeyError:
			pass
		try:
			print '[*] Name Belakang : '+y['last_name']
		except KeyError:
			pass
		try:
			...
			pass
		try:
			print '[*] Lokasi : '+y['location']['name']
		except KeyError:
			pass
		try:
			print '[*] Asal : '+y['hometown']['name']
		except KeyError:
			pass
		try:
			print '[*] Jenis Kelamin : '+y['gender']
		except KeyError:
			pass
		try:
			print '[*] Agama: '+y['religion']
		except KeyError:
			pass
		try:
			print '[*] Hubungan : '+y['relationship_status']
		except KeyError:
			pass
		try:
			print '[*] Pandangan Politik: '+y['political']
		except KeyError:
			pass
		try:
			print '[*] work :'
			...
			for i in y['work']:
				...
				try:
					...
					pass
				try:
					if i['Mulai_date'] == "0000-00":
						print '   [-] Mulai date : ---'
					else:
						print '   [-] Mulai date : '+i['Mulai_date']
				except KeyError:
					pass
				try:
